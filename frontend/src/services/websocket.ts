...
const wsBase = process.env.NEXT_PUBLIC_WS_URL ?? httpBase.replace(/^http/, 'ws');
...
class ChatWebSocketClient {
    ...
    on<EventName extends keyof SocketEvents>(event: EventName, handler: (event: SocketEvents[EventName]) => void) {
